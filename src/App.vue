<template>
  <div id="app"> <!-- É um Flex Box -->
      <h1>Problema de Montyhall</h1>
      <div class="form">
          <div v-if="!started">
              <label for="portsAmount">Quantas portas? </label>
              <input type="text" id="portsAmount" size="3"
                    v-model.number="portsAmount"> <!-- Vai converter a String num valor numerico. -->
          </div>
          <div v-if="!started">
...
<script>
import Door from './components/DoorSpecial.vue'
...
<!-- Um Componente encapsula HTML, CSS e JS. -->